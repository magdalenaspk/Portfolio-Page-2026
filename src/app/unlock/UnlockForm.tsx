...
export function UnlockForm({ hasError }: { hasError: boolean }) {
      ...
      <div>
        <div className="relative">
          <input
            ...
            autoFocus
            className="w-full px-4 py-3 pr-12 rounded-xl border border-neutral-200 bg-white text-neutral-900 placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-lime-300 focus:border-transparent transition-all text-sm"
          />
          <button
            type="button"
            onClick={() => setShow((s) => !s)}
